from fastapi import FastAPI, HTTPException, BackgroundTasks, Depends, HTTPBearer, HTTPAuthorizationCredentials
...
async def root():
    """Root endpoint."""
    return {
        "message": "Simple Skill Swap Recommendation Engine",
        "version": "1.0.0",
        "status": "running"
    }
